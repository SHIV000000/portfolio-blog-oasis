...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground pt-20">
      {/* Hero Section */}
      <section className="container mx-auto px-4 py-20 border-2 border-white/20">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 border-2 border-white/20 py-12">
          <h2 className="text-4xl font-bold mb-12 text-left">Projects</h2>
          <div className="grid md:grid-cols-1 gap-4">
            {projects.map((project) => (
              <div key={project.title} className="bg-muted p-6 rounded-none border-2 border-white/20 hover:border-white/40 transition-all duration-300">
      ...
      <section className="container mx-auto px-4 py-20 border-2 border-white/20">
        ...
        <div className="space-y-8">
          {experiences.map((exp) => (
            <div key={exp.role} className="border-l-4 border-white/20 pl-6 hover:border-white/40 transition-colors">
              <div className="flex justify-between items-center">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 border-2 border-white/20 py-12">
          ...
          <form onSubmit={handleSubmit} className="max-w-2xl mx-auto space-y-6">
            <div className="grid grid-cols-2 gap-6">
              <div>
                <input
                  ...
                  className="w-full p-3 bg-muted rounded-none border-2 border-white/20 focus:border-white/40 focus:outline-none transition-colors"
                  required
                />
              </div>
              <div>
            ...
            <button
              type="submit"
              className="w-full bg-muted text-white py-3 border-2 border-white/20 hover:border-white/40 transition-colors"
            >
              Submit
            </button>
          </form>
